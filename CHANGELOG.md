...
### Notes
- These changes are merged on `main` and awaiting release as `0.1.2` after visual sign-off in a real Obsidian vault.
...
[Unreleased]: https://codeberg.org/jkaindl/json-editor/compare/0.1.1...HEAD
