...
- **Latest release:** `1.11.3` (Two defects that 726 green tests could not see, both found by the new drivers on the day they were built: the first Ctrl/Cmd+Z after a tree edit did nothing, and the breadcrumb kept the previous file's path after a switch. Ships the seven README pictures with it.)
